...
#### Scenario: Progress bar uses hardcoded consumed value
- **WHEN** the API Request Limit is set to any value
- **THEN** the consumed count used to compute progress SHALL be 800 (hardcoded placeholder)
